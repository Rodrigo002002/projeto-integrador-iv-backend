...
public class AulaSpecification {
    public static Specification<Aula> getFilters(String search, Boolean status) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (search != null) {
                ...
                Predicate titlePredicate = criteriaBuilder.like(criteriaBuilder.lower(root.get("data")), searchPattern);
