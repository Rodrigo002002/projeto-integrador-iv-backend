...
public class TipoServicoSpecification {
    public static Specification<TipoServico> getFilters(String search, Boolean status) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (search != null) {
                ...
                Predicate titlePredicate = criteriaBuilder.like(criteriaBuilder.lower(root.get("tipo")), searchPattern);
