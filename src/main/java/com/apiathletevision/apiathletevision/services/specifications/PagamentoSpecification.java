...
public class PagamentoSpecification {
    public static Specification<Pagamento> getFilters(String search, Boolean status) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (search != null) {
                ...
                Predicate titlePredicate = criteriaBuilder.like(criteriaBuilder.lower(root.get("valor")), searchPattern);
